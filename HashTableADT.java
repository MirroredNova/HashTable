/**
 * Filename: HashTableADT.java Project: p3-201901 Course: cs400 Authors: Debra
 * Deppeler
 * 
 ...
 * 
 * May not use Java's HashTable, TreeMap, HashMap, etc. May not add or edit any
 * public members of this ADT May not add or edit any public members to for your
 * implementation.
 *
 * DO NOT EDIT OR SUBMIT THIS INTERFACE
 */
public interface HashTableADT<K extends Comparable<K>, V>
		extends DataStructureADT<K, V> {
	...
	// strategies
	// and implement this method to return an integer to indicate which
	// strategy.
	//
